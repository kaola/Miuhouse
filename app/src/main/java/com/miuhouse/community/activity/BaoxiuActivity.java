...
import com.miuhouse.community.activity.album.MultiImageSelectorActivity;
import com.miuhouse.community.adapter.UpdateImageAdapter;
import com.miuhouse.community.application.MyApplication;
import com.miuhouse.community.bean.BaseBean;
import com.miuhouse.community.bean.Complain;
...
import com.miuhouse.community.widget.PassportDialogBuilder;
...
public class BaoxiuActivity extends BaseActivity {
    ...
    @Override public void initView() {
        ...
        updateAdapter.setOnDelectClickListener(new UpdateImageAdapter.OnDelectClickListener() {
            ...
            @Override public void onDelectClick(int position) {
        ...
        findViewById(R.id.action).setOnClickListener(new View.OnClickListener() {
            ...
            @Override public void onClick(View v) {
                ...
                startActivity(new Intent(activity, MyComplainActivity.class).putExtra("type",
                    Complain.REPAIR));
            }
        });
    }
    ...
    private void update() {
        ...
        CustomStringRequest custom =
            new CustomStringRequest(Request.Method.POST, urlPath, map, getListener(),
                getErrorListener());
        custom.setTag(TAG);
