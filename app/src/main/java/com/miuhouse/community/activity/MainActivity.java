...
import com.miuhouse.community.bean.Contact;
import com.miuhouse.community.bean.Notification;
import com.miuhouse.community.db.AccountDBTask;
import com.miuhouse.community.db.ContactDao;
import com.miuhouse.community.db.NotificationDao;
import com.miuhouse.community.fragment.FragmentFactory;
import com.miuhouse.community.fragment.HomeFragment;
import com.miuhouse.community.fragment.MessageFragment;
import com.miuhouse.community.fragment.MyFragment;
...
import com.miuhouse.community.manager.DictManager;
...
import com.miuhouse.community.widget.MyDot;
    ...
    //        implements EMEventListener
{
    ...
    private Button btnMe, btnMessage, btnHome;
    ...
    public void initData() {
        ...
        if (!MyUtils.isLoggedIn()) {
            if (mPushAgent != null && mPushAgent.isEnabled()) {
                mPushAgent.disable();
            }
        }
    ...
    private void setListener() {
        ...
        mPushAgent.setMessageHandler(new UmengMessageHandler() {
            ...
            public void handleMessage(Context context, UMessage uMessage) {
                ...
                showLogD("handleMessage : " + uMessage.toString());
                Map<String, String> extra = uMessage.extra;
                if (extra.get("status") == null) {  //收到的是公告,组装通知对象
                    ...
                    AccountDBTask.updateStatus(MyApplication.getInstance().getUserBean().getId(),
