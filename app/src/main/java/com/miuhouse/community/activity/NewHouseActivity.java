...
import com.miuhouse.community.activity.photo.GalleryActivity;
import com.miuhouse.community.adapter.DiscountAdapter;
import com.miuhouse.community.adapter.HuxingAdapter;
import com.miuhouse.community.adapter.OtherPropertyAdapter;
import com.miuhouse.community.bean.BaseBean;
import com.miuhouse.community.bean.Discount;
import com.miuhouse.community.bean.Huxing;
...
import com.miuhouse.community.widget.AutoColumnLinearLayout;
import com.miuhouse.community.widget.MyGridView;
import com.miuhouse.community.widget.MyListView;
...
public class NewHouseActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        expandToggle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final LinearLayout.LayoutParams params =
                    (LinearLayout.LayoutParams) expand.getLayoutParams();
                int duration = 500;

                Animation animation = null;
                if (!isExpanded) {
                    RotateAnimation animationExpand =
                    ...
                    RotateAnimation animationCollapse =
        ...
        findViewById(R.id.share).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyUtils.handleShare(NewHouseActivity.this,
                    "http://app.miuhouse.com/mobile/newPropertyInfo/"
                        + property.getId(),
                    property.getName() + " " + property.getAvgPrice() + "元/㎡起",
                    (property.getImages() != null && property.getImages().size() > 0)
                        ? property.getImages().get(0) : null);
            }
        });
    }
    ...
    private void getNewPropertyInfo() {
        ...
        map.put("id", id);
        GsonRequest<NewHouseBean> request =
            new GsonRequest<NewHouseBean>(Request.Method.POST, url, NewHouseBean.class, map,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        ((TextView) nonetwork.findViewById(R.id.tv_main)).setText(
    ...
    private void fillView(NewHouseBean newHouseBean) {
        ...
        mTvJianzhumianji.setText(property.getJzmj() + "㎡");
        mTvZhandimianji.setText(property.getZdmj() + "㎡");
        ...
        mTvWuyefei.setText(property.getWyf() + "元/㎡/月");
        ...
        mTvPriceTotal.setText(property.getAvgPrice() + "元/㎡");
        ...
        Glide.with(this).load(getStr(property.getMapUrl()))
            .placeholder(R.mipmap.default_error_big)
            .into(mLocationImg);
        ((TextView) findViewById(R.id.surrounding)).setText(
            "楼盘地址：" + getStr(property.getCity() + property.getArea() + property.getStreet()));
    ...
    private void getOtherProperties() {
        ...
        GsonRequest<OtherProperties> request =
            new GsonRequest<>(Request.Method.POST, url, OtherProperties.class, map,
                new Response.Listener<OtherProperties>() {
                    ...
                    public void onResponse(final OtherProperties otherProperties) {
                        if (otherProperties.getCode() == 0
                            ...
                            OtherPropertyAdapter oAdapter = new OtherPropertyAdapter(activity,
                                otherProperties.getNewPropertyInfos());
                            mOtherList.setAdapter(oAdapter);
                            backToTheTop();
                            mOtherList.setOnItemClickListener(
                                new AdapterView.OnItemClickListener() {
                                    @Override
                                    public void onItemClick(AdapterView<?> parent, View view,
                                        int position, long id) {
                                        startActivity(new Intent(activity, NewHouseActivity.class)
                                            .putExtra("id", otherProperties.getNewPropertyInfos()
                                                .get(position)
                                                .getId()));
                                        finish();
                                    }
