...
import com.miuhouse.community.activity.HouseDetailActivity;
...
import com.miuhouse.community.bean.ZFZBean;
...
//                }
                ...
                holder.propertyPrice.setText(String.valueOf(mList.get(position).getAvgPrice()) + "元/㎡");
